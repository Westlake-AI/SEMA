...
# ImageNet dataset
data_train_list = 'data/meta/IMDB_WIKI/train_labeled.txt'
data_train_root = 'data/IMDB_WIKI/'
data_test_list = 'data/meta/IMDB_WIKI/test_labeled.txt'
data_test_root = 'data/IMDB_WIKI/'
